...
| `videos/policy_success_20k_world/` | World-camera-only derivatives of both verified 20K policy successes |
| `videos/data_collection/` | Successful strict-physics Physical-2K collection episodes for apple, banana, and plum |
| `videos/task_success_world/` | One certified world-camera Physical-2K success for each of the 20 fruit-and-destination tasks |
...
| `evidence/world_success_examples.json` | Task, episode, seed, source timestamps, checksums, and certificate provenance for all 20 world-camera examples |
